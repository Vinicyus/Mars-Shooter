...
pygame.display.set_caption("Mars Shooter")
...
while running:
	...
	if game.is_playing:
		# declencher les indtructions de la partie
		game.update(screen)
	...
	#metter à jour l'ecran
	pygame.display.flip()

	# si le joueur ferme cetter fenetre
	for event in pygame.event.get():
		...
		#detecter si un joueur lache une touche du clavier
			...
			#detecter si la touche espace est enclenchés  pour lancer notre projectile
