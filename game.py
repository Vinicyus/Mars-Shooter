...
#creer ine seconde classe qui va representer  notre jeu
class Game:
	"""docstring for Game"""
	def __init__(self):
		...
		#mettre le score à 0
		self.font = pygame.font.SysFont("assets/my_custom_font.ttf", 25)
		self.score = 0
		self.pressed = {}
	...
	def game_over(self):
		# remettre le jeu à neuf, retirer les monstres le joueur á 100 de vie, jeu en attente
		self.all_monsters = pygame.sprite.Group()
	...
	def update(self, screen):
		...
		#acrualiser la barre de vie du joueur
		self.player.update_health_bar(screen)

		# actualiser la barre d'evenement su jeu
